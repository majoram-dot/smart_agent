...
if TYPE_CHECKING:
    from ..memory.core import AgentLogger
...
import os
from smart_agent import GradioUI, {{ class_name }}, {{ agent_dict['model']['class'] }}
...
class Retrying:
    """Simple retrying controller. Inspired from library tenacity."""
