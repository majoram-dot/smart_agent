...
from ..tools.default import FinalAnswerTool
from .local_python import CodeOutput, PythonExecutor
from ..monitoring.core import LogLevel
from ..serialization.core import SafeSerializer, SerializationError
from ..tools.core import Tool, get_tools_definition_code
from ..utils.general import AgentError
...
class RemotePythonExecutor(PythonExecutor):
    ...
    def send_tools(self, tools: dict[str, Tool]):
        ...
        packages_to_install = {
            ...
            if pkg not in self.installed_packages + ["smart_agent"]
        }
        ...
        **kwargs,
        ...
        try:
            ...
            raise ModuleNotFoundError(
                """Please install 'e2b' extra to use E2BExecutor: `pip install 'smart_agent[e2b]'`"""
            )
...
class DockerExecutor(RemotePythonExecutor):
    ...
    def __init__(
        ...
        try:
            ...
            raise ModuleNotFoundError(
                "Please install 'docker' extra to use DockerExecutor: `pip install 'smart_agent[docker]'`"
            )
        self.host = host
        self.port = port
...
class ModalExecutor(RemotePythonExecutor):
    ...
    def __init__(
        ...
        try:
            ...
            raise ModuleNotFoundError(
                """Please install 'modal' extra to use ModalExecutor: `pip install 'smart_agent[modal]'`"""
            )
...
class BlaxelExecutor(RemotePythonExecutor):
    ...
    def __init__(
        ...
        try:
            ...
            raise ModuleNotFoundError(
                "Please install 'blaxel' extra to use BlaxelExecutor: `pip install 'smart_agent[blaxel]'`"
            )
